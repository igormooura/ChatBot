...
const consultasSimuladas: Consulta[] = [
  ...
  { id: 2, medico: "Dra. Maria Souza", especialidade: "Dermatologia", paciente: "Igor Moura", data: "2025-07-10", horario: "15:30" },
  { id: 3, medico: "Dr. Carlos Pereira", especialidade: "Ortopedia", paciente: "Igor Moura", data: "2025-07-20", horario: "09:00" },
];
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow bg-gradient-to-r from-blue-50 via-white to-blue-50 p-8">
        <h1 className="text-4xl font-extrabold mb-10 text-center text-blue-900">Minhas Consultas</h1>
        {consultasSimuladas.length === 0 ? (
          <p className="text-center text-gray-600 text-lg">Você ainda não marcou nenhuma consulta.</p>
        ) : (
